<?php
    ...
    $query = "SELECT * FROM ANDREWSDREAMLLC.property JOIN ANDREWSDREAMLLC.property_amenity ON ANDREWSDREAMLLC.property.PROPERTY_KEY = ANDREWSDREAMLLC.property_amenity.PROPERTY_KEY JOIN ANDREWSDREAMLLC.property_media ON ANDREWSDREAMLLC.property.PROPERTY_KEY = ANDREWSDREAMLLC.property_media.PROPERTY_KEY WHERE PROPERTY_IDENTIFIER = 'R' AND PROPERTY_AVAILABLE = 1 GROUP BY ANDREWSDREAMLLC.property.PROPERTY_KEY";
    ...
    if(mysqli_num_rows($result) > 0)
    {
        ...
        while($row = mysqli_fetch_assoc($result)) 
        {
            ...
            $property["IMAGE"] = $row["PROPERTY_IMAGE"];
