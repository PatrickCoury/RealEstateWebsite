<?php
    ...
    $query = "SELECT * FROM ANDREWSDREAMLLC.property JOIN ANDREWSDREAMLLC.property_amenity ON ANDREWSDREAMLLC.property.PROPERTY_KEY = ANDREWSDREAMLLC.property_amenity.PROPERTY_KEY";
    ...
    if(mysqli_num_rows($result) > 0 )
    {
        ...
        while($row = mysqli_fetch_assoc($result)) 
        {
            ...
            $property["PROPERTY_SQUARE_FEET"] = $row["PROPERTY_SQUARE_FEET"];
            $property["PROPERTY_PARKING"] = $row["PROPERTY_PARKING"];
            $property["PROPERTY_BED"] = $row["PROPERTY_BED"];
            $property["PROPERTY_BATH"] = $row["PROPERTY_BATH"];
