...
CREATE TABLE `about_us` (
  ...
  `COMPANY_CONTACT_NUMBERl ` varchar(255) NOT NULL,
  `COMPANY_FAX_NUMBER` varchar(255) DEFAULT NULL,
...
CREATE TABLE `sale_property` (
  `SALE_PROPERTY_KEY` int NOT NULL AUTO_INCREMENT,
...
-- Dump completed on 2020-02-05 21:58:38
